...
※管理会社が設備情報を未入力の場合にハード除外で取りこぼすのを防ぐため、大半の設備はソフト扱い。

| ID | 設備名 | facilities 内検索キーワード | 備考 |
|---|---|---|---|
| 11010 | バス・トイレ別 | `バス・トイレ別`, `BT別` | 旧ハード設備 |
| 11020 | 温水洗浄便座 | `温水洗浄便座` | |
| 11040 | 追い焚き | `追い焚き`, `追焚` | 旧ハード設備 |
| 11050 | 浴室乾燥機 | `浴室乾燥` | |
| 11060 | 独立洗面台 | `独立洗面` | |
| 11080 | 室内洗濯機置場 | `室内洗濯` | 旧ハード設備 |
| 12032 | コンロ2口以上 | `2口`, `3口` | |
| 12033 | コンロ3口以上 | `3口` | 旧ハード設備 |
| 13010 | エアコン付き | `エアコン` | |
| 13020 | 床暖房 | `床暖房`, `床暖` | 旧ハード設備 |
| 14012 | ウォークインクローゼット | `ウォークインクローゼット`, `WIC`, `ウォークイン` | 旧ハード設備 |
| 16010 | オートロック | `オートロック` | 旧ハード設備 |
| 16011 | TVモニタ付きインタホン | `モニター付`, `TVモニタ` | |
| 19040 | エレベーター | `エレベーター`, `EV` | 旧ハード設備 |
| 19090 | 駐輪場 | `駐輪場`, `駐輪` | 旧ハード設備 |
...
**ハード設備 — itandi API `option_id:all_in` / ES-Square `kodawari` で厳密に除外:**

※管理会社が設備未入力の場合に取りこぼすため、ハード設備は最小限に絞っている。
...
|---|---|---|---|
| 11010 | バス・トイレ別 | バス・トイレ別 | 旧ハード設備 |
| 11020 | 温水洗浄便座 | 温水洗浄便座 | |
| 11040 | 追い焚き機能 / 追い焚き / 追い焚き風呂 | 追い焚き風呂 | 旧ハード設備 |
| 11050 | 浴室乾燥機 | 浴室乾燥機 | |
| 11060 | 独立洗面台 | 独立洗面台 | |
| 11080 | 室内洗濯機置き場 / 室内洗濯機置場 | 室内洗濯機置場 | 旧ハード設備 |
| 12032 | コンロ2口 / コンロ2口以上 / 2口以上コンロ | コンロ2口以上 | |
| 12033 | コンロ3口以上 | コンロ3口以上 | 旧ハード設備 |
| 13010 | エアコン / エアコン付き | エアコン付き | |
| 13020 | 床暖房 | 床暖房 | 旧ハード設備 |
| 14012 | ウォークインクローゼット | ウォークインクローゼット | 旧ハード設備 |
| 14020 | シューズボックス | シューズボックス | |
| 15021 | インターネット無料 | インターネット無料 | |
| 16010 | オートロック | オートロック | 旧ハード設備 |
| 16011 | モニター付きインターホン / TVモニタ付きインタホン | TVモニタ付きインタホン | |
| 19040 | エレベーター | エレベーター | 旧ハード設備 |
| 19090 | 駐輪場 / 駐輪場あり | 駐輪場あり | 旧ハード設備 |
| 21020 | 宅配ボックス | 宅配ボックス | |
...
class CustomerCriteria:
    ...
    equipment_ids: list[int]           # ハード設備 option_id リスト（API除外用）※家具家電付き・ペット相談・事務所可のみ
    soft_equipment_ids: list[int]      # ソフト設備 ID リスト（アラート用、大半の設備はこちら）
