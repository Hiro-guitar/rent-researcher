...
EQUIPMENT_IDS: dict[str, int] = {
    ...
    # ── キッチン（追加） ──
    "ガスコンロ対応": 12030,
    "ガスコンロ設置可": 12030,       # alias
    "IHコンロ": 12020,
    "IHクッキングヒーター": 12020,   # alias
    "システムキッチン": 12010,
    # ── ライフライン ──
    "都市ガス": 10020,
    "プロパンガス": 10021,
...
SOFT_EQUIPMENT_IDS: set[int] = {
    ...
    22020,  # 楽器相談可
    14010,  # 収納
    90004,  # 敷地内ゴミ置場（API option_id なし — 内部用仮ID）
    90005,  # ルーフバルコニー付（API option_id なし — 内部用仮ID）
