...
function makePreviewHtml(prop, customerName, roomId) {
  ...
  html += '<script>'
    ...
    + '.withSuccessHandler(function(r){'
    + 'if(r.success){'
    + 'document.body.innerHTML="<div style=\\"text-align:center;padding:60px;font-family:sans-serif\\"><h2 style=\\"color:#4CAF50\\">\\u2705 "+r.message+"</h2><div id=\\"cd\\" style=\\"color:#888;font-size:13px;margin-top:12px\\">2\\u79D2\\u5F8C\\u306B\\u30BF\\u30D6\\u3092\\u9589\\u3058\\u307E\\u3059\\u2026</div><div id=\\"closeHint\\" style=\\"display:none;margin-top:20px;padding:10px 16px;background:#f0f4f8;border-radius:8px;color:#555;font-size:13px\\">\\u26A0\\uFE0F \\u30D6\\u30E9\\u30A6\\u30B6\\u306E\\u5236\\u9650\\u3067\\u81EA\\u52D5\\u3067\\u9589\\u3058\\u3089\\u308C\\u307E\\u305B\\u3093\\u3067\\u3057\\u305F\\u3002\\u3053\\u306E\\u30BF\\u30D6\\u306F\\u624B\\u52D5\\u3067\\u9589\\u3058\\u3066\\u304F\\u3060\\u3055\\u3044\\u3002</div></div>";'
    + 'var n=2;var t=setInterval(function(){n--;var cd=document.getElementById("cd");if(cd)cd.textContent=n+"\\u79D2\\u5F8C\\u306B\\u30BF\\u30D6\\u3092\\u9589\\u3058\\u307E\\u3059\\u2026";if(n<=0){clearInterval(t);try{window.top.close();}catch(e){}try{window.close();}catch(e){}setTimeout(function(){if(cd)cd.style.display="none";var h=document.getElementById("closeHint");if(h)h.style.display="block";},400);}},1000);'
    + '}else{'
