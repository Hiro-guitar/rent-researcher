 ...
 */
// ⚠️ '検索のみ' と '追客中（優先）' は担当者が手で入れる列。
//   _fillDefaultStages_ で自動割り当てしないこと。
//   「優先すべきか」「声かけをやめて配信だけにするか」はデータから判定できず、
//   人の判断だけで決まる。一度入れたら状態が変わっても勝手に動かさない。
var KANBAN_STAGE_LIST = ['メールのみ', '未接続', '検索のみ', '追客中', '追客中（優先）', '申込', '成約', '終了'];
